...
export default function LoginPage() {
    ...
    return (
        <div className="flex justify-center items-center h-screen w-screen">
            <Card>
                <h1 className="text-white text-xl font-bold mb-10 mt-10">Login</h1>
                ...
                >
                    ...
                    <button
                        type="submit"
                        className="bg-white text-[#088395] font-bold py-2 px-6 rounded-full mt-2 w-[100px]"
                    >
                        Login
                    </button>
                </form>
                ...
                {/* Extra Links */}
                <div className="mt-20 text-center text-sm text-white w-[330px]">
