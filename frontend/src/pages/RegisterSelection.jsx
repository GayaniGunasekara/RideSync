...
export default function RegisterSelection() {
    ...
    return (
        <div className="flex justify-center items-center h-screen w-screen">
            ...
            <Card>
                {/* Page Title */}
                <h1 className="text-white text-xl font-bold mb-10 mt-10">Register</h1>

                {/* Subtitle */}
                <p className="text-white mb-10">You Are,</p>

                {/* ✅ Workshop Owner Button */}
                <button
                    // Use the route path defined in App.jsx, not the file path
                    onClick={() => navigate("/registerWorkshopOwner")}
                    className="bg-white text-[#088395] font-bold py-3 px-6 rounded-xl mb-4 hover:opacity-90 "
                >
                ...
                <button
                    ...
                    className="bg-white text-[#088395] font-bold py-3 px-6 rounded-xl hover:opacity-90 mt-5"
                >
                    Vehicle Owner
                </button>
            </Card>
